...
// RequestOption is an option for the requests made by the ocm API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/andreibesleaga/ocm-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.openchargemap.io/v3/")
}
...
func WithBearer(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.Bearer = value
		return r.Apply(WithHeader("authorization", fmt.Sprintf("Bearer %s", r.Bearer)))
	})
}
