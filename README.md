...
The ocm library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
`*ocm.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `ocm.File(reader io.Reader, filename string, contentType string)`
