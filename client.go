...
// interacting with the ocm API. You should not instantiate this client directly,
...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("OCM_API_KEY"); ok {
...
// environment (OCM_API_KEY, OCM_API_KEY, OCM_USERNAME, OCM_BASE_URL). The option
...
func NewClient(opts ...option.RequestOption) (r Client) {
	...
	r.Referencedata = NewReferencedataService(opts...)
	r.Profile = NewProfileService(opts...)
	r.Comment = NewCommentService(opts...)
	r.Mediaitem = NewMediaitemService(opts...)
