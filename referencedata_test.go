...
func TestReferencedataGetWithOptionalParams(t *testing.T) {
	...
	_, err := client.Referencedata.Get(context.TODO(), ocm.ReferencedataGetParams{
		Countryid: []any{map[string]any{}},
	})
	if err != nil {
