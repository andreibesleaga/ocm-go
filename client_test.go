...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Poi.List(context.Background(), ocm.PoiListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Poi.List(cancelCtx, ocm.PoiListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Poi.List(deadlineCtx, ocm.PoiListParams{})
		if err == nil {
